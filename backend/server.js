...
function ensureTablesExist() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS weight_schemes (
      ...
      weight_weight REAL NOT NULL,
      weight_evasion REAL NOT NULL,
      weight_energy REAL NOT NULL,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
      updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
    );
    ...
    CREATE INDEX IF NOT EXISTS idx_weight_schemes_name ON weight_schemes(name);
  `);
