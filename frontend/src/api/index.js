...
export const vehiclesAPI = {
  ...
  getSchemes: () => api.get("/vehicles/schemes"),
  createScheme: (data) => api.post("/vehicles/schemes", data),
  recalculateWithScheme: (id) =>
    api.post(`/vehicles/schemes/${id}/recalculate`),
  deleteScheme: (id) => api.delete(`/vehicles/schemes/${id}`),
};
